          ...
          <Grid item xs={12} sx={{ margin: "20px" }}>
            <TrimCorrectionTable>
              ...
              <TrimCorrectionRow>
                ...
                <TrimCorrectionValue>
                  {newDisplacementCorrectedByDensity.toFixed(2)}
                </TrimCorrectionValue>
              </TrimCorrectionRow>
            </TrimCorrectionTable>
          </Grid>
